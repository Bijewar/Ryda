...
interface LocationState {
  ...
  driverLocation: { point: Point; heading?: number | undefined; etaSeconds?: number | undefined } | null;
  isInsideBhopal: boolean;

  setPickup: (p: { address: string; point: Point } | null) => void;
  setDropoff: (p: { address: string; point: Point } | null) => void;
  setDriverLocation: (loc: { point: Point; heading?: number | undefined; etaSeconds?: number | undefined } | null) => void;
